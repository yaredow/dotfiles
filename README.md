...
- **Centralized theming** — pick a theme and every app restyles: Hyprland, kitty, fastfetch, btop, starship, nvim, herdr and more
...
```
theme-set.sh <name>
  ├─ render templates → kitty / hypr / fastfetch / btop / starship / herdr / opencode
