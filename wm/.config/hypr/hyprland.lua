...
hl.config({
	misc = {
		force_default_wallpaper = 2, -- Set to 2 to disable default wallpapers entirely
		disable_hyprland_logo = true, -- Disable the default hyprland background layer
	},
})
...
hl.bind("SUPER + ALT + SPACE", hl.dsp.exec_cmd("qs ipc call launcher menu"))
...
-- Laptop multimedia keys for volume and LCD brightness (handled via qs OSD)
